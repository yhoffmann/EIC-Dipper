#pragma once
#ifndef EIC_SATURATIONMODEL_HPP_
#define EIC_SATURATIONMODEL_HPP_
...
// double dsigma_d2b_sqr(double x1, double x2, double y1, double y2, double xb1,
// double xb2, double yb1, double yb2, const HotspotNucleus* nucleus);
...
#endif  // EIC_SATURATIONMODEL_HPP_
